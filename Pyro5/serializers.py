...
class SerializerBase(object):
    ...
    def dumpsCall(self, obj, method, vargs, kwargs):
        """Serialize the given method call parameters"""
        raise NotImplementedError("implement in subclass")

    def loads(self, data):
        """Deserializes the given data (bytes)."""
        raise NotImplementedError("implement in subclass")
    ...
    def class_to_dict(cls, obj):
        ...
        try:
            ...
            if hasattr(obj, "__slots__"):
                ...
                raise errors.SerializationError("don't know how to serialize class " + str(obj.__class__) + " using serializer " + str(cls.__name__) + ". Give it vars() or an appropriate __getstate__")
...
class MsgpackSerializer(SerializerBase):
    ...
    def default(self, obj):
        ...
        if isinstance(obj, datetime.datetime):
            if obj.tzinfo:
                raise errors.SerializationError("msgpack cannot serialize datetime with timezone info")
    ...
    def ext_hook(self, code, data):
        ...
        raise errors.SerializationError("invalid ext code for msgpack: "+str(code))
